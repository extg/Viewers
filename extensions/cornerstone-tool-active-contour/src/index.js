...
import { toolColors } from 'cornerstone-tools';
// import drawHandles from 'cornerstone-tools/drawing/drawHandles.js';
import { store } from 'cornerstone-tools';
// import { getToolState } from 'cornerstone-tools/stateManagement/toolState.js';
// import { clipToBox } from 'cornerstone-tools/util/clip.js';
import { getToolForElement } from 'cornerstone-tools';
// import {
//   hideToolCursor,
//   setToolCursor,
// } from 'cornerstone-tools/store/setToolCursor.js';
// import freehandUtils from 'cornerstone-tools/util/freehand/index.js';

const { state } = store;

// Вот эти штуки не получилось импортнуть
let drawHandles, getToolState, clipToBox, hideToolCursor, setToolCursor, freehandUtils;

console.log('csTools', csTools);

const { freehandRoiSculptorCursor } = csTools.importInternal(
  'cursors/index.js'
);
